...
/// with algebraic no-arb barrier, multi-start sweep, calendar spread penalty).
///
/// Usage: cargo run --bin fit_direct -- <ticker> <date>
///   e.g. cargo run --bin fit_direct -- spx 2026-03-07
///
/// Three sections:
...
use essvi::direct_solver::{DirectCalibConfig, SliceInput, calibrate_surface};
...
/// Output of direct solver calibration for one slice.
struct FitOutput {
    t: f64,
    theta: f64,
    eta: f64,
