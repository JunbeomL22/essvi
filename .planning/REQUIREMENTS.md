...
- [x] **BLK-01**: User can compute undiscounted option price and delta for calls/puts
- [x] **BLK-02**: User can compute individual greeks (gamma, vega, theta) and combined gamma_vega
- [x] **BLK-03**: User can compute all greeks in a single call (price, delta, gamma, vega, theta)
- [x] **BLK-04**: User can compute discounted option price directly
- [x] **BLK-05**: Library provides PricingError type with AboveMaximum, BelowIntrinsic, InvalidInput variants
